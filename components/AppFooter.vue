        ...
        <div>
          ...
          <ul class="space-y-3">
            <li v-for="link in productLinks" :key="link.name">
              <NuxtLink :to="link.href" class="text-gray-400 hover:text-accent-400 transition-colors duration-300 text-sm">
                {{ link.name }}
              </NuxtLink>
            </li>
          </ul>
      ...
      <div class="mt-12 pt-8 border-t border-primary-700/50 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex items-center gap-6">
          <a
            ...
            class="text-gray-400 hover:text-accent-400 transition-colors duration-300"
...
const socialLinks = [
  { name: 'Twitter', href: 'https://twitter.com/metricalgo', icon: TwitterIcon },
  { name: 'GitHub', href: 'https://github.com/metricalgo', icon: GithubIcon },
  { name: 'LinkedIn', href: 'https://linkedin.com/company/metricalgo', icon: LinkedInIcon },
]
</script>
